...
const products = [
  {
    id: 101,
    title: "رول دئودورانت زنانه شون مدل Heaven Flower حجم 50 میل",
    image: "https://mootanroo.com/images/thumbs/0228440_schon-rool-deodorant-heaven-flower-112181222303-01.jpg.jpeg",
    description: `رول دئودورانت زنانه شون مدل Heaven Flower دارای فرمولاسیون مدرن با حداکثر اثربخشی برای جلوگیری از تعریق و ایجاد بوی بد در تمام طول روز است. بهره ­گیری از عصاره های گیاهی و تلفیق شگفت انگیزی از رایحه های طبیعی گلهای سفید و میوه ­های تازه رایحه­ های ملایم زنانه را به شما هدیه می دهد.این محصول فاقد الکل بوده و روی لباس لکه ایجاد نمی­کند. دئودورانت شون مناسب تمامی انواع پوست می باشد. فرمولاسیون مدرن با بهره­ گیری از خواص گیاهی و رایحه­ های شگفت­ انگیز طبیعی، بدون استفاده از الکل و پارابن، این محصول را برای تمامی انواع سلیقه­ ها و تمامی انواع پوست­ها مناسب ساخته است.`,
    price: "۴۷/۴۳۰تومان"
  },
  {
    id: 102,
    title: "رول دئودورانت زنانه مای مدل Tulip حجم 50 میل",
    image: "https://mootanroo.com/images/thumbs/0229801_my-deorollon-tulip-120181222301.jpg.jpeg",
    description: `حس این رول دئودورانت زنانه مای مدل Tulip مانند شفافیت نور خورشید در دشت های گل لاله است. رایحه آن با بوی شکوفه های پرتقال، گل های فریزیا، گل نیلوفر و لیمو آغاز می شود و در پایان شمیم معطر مشک و عنبر بر جای می گذارد. همچنین این رول مای 24ساعته بوده و دارای ماندگاری فوق العاده بالایی است و هیچ گونه لکه سفید و سفیدک بر روی لباستان به جا نمی گذارد. این محصول مای فاقد الکل بوده و مناسب پوست های حساس می باشد. برند مای با پیشینه ای طولانی و روشن در طیف وسیعی از محصولات آرایشی و بهداشتی اقدام به برطرف کردن نیاز ایرانیان نموده است. مراقبت از پوست و مو به فاکتورهای مختلفی مانند ویژگی های ژنتیکی، موقعیت جغرافیایی و عوامل دیگر بستگی دارد. لازم به ذکر است که کیفیت محصولات مای در سطح بزرگترین برندهای بین المللی است.
  ...
  {
    id: 103,
    title: "رول دئودورانت زنانه شون مدل Pink Princess حجم 50 میل",
    image: "https://mootanroo.com/images/thumbs/0380002_-pink-princess-50-.jpeg",
    description: `رول دئودورانت زنانه شون مدل Pink Princess دارای فرمولاسیون مدرن با حداکثر اثربخشی برای جلوگیری از تعریق و ایجاد بوی بد در تمام طول روز است. بهره ­گیری از عصاره ­های گیاهی و تلفیق شگفت ­انگیزی از رایحه­ ی میوه های جنگلی یک روز نشاط بخش را برای شما به ارمغان می آورد.این محصول فاقد الکل و پارابن بوده و روی لباس لکه ایجاد نمی­کند. دئورولان شون مناسب تمامی انواع پوست می باشد. فرمولاسیون مدرن با بهره گیری از خواص گیاهی و رایحه­ های شگفت انگیز طبیعی، بدون استفاده از الکل و پارابن، این محصول را برای تمامی انواع سلیقه ها و تمامی انواع پوست ها مناسب ساخته است.
  ...
  {
    id: 104,
    title: "رول دئودورانت مردانه مای مدل Power Lift حجم 50 میل",
    image: "https://mootanroo.com/images/thumbs/0229833_my-deorollon-power-lift-120181222304.jpg.jpeg",
    description: `رول دئودورانت مردانه مای مدل Power Lift دارای رایحه دلچسب مرکبات مثل لیموی تازه، برگاموت و شکوفه های پرتقال همراه با دانه لوبیا تونکا است که دئودورانت پاورلیفت به جای می گذارد. همچنین این رول مای 24ساعته بوده و دارای ماندگاری فوق العاده بالایی است و هیچ گونه لکه سفید و سفیدک بر روی لباستان به جا نمی گذارد. این محصول مای فاقد الکل بوده و مناسب پوست های حساس می باشد. برند مای با پیشینه ای طولانی و روشن در طیف وسیعی از محصولات آرایشی و بهداشتی اقدام به برطرف کردن نیاز ایرانیان نموده است. مراقبت از پوست و مو به فاکتورهای مختلفی مانند ویژگی های ژنتیکی، موقعیت جغرافیایی و عوامل دیگر بستگی دارد. لازم به ذکر است که کیفیت محصولات مای در سطح بزرگترین برندهای بین المللی است.
  ...
  {
    id: 105,
    title: "بادی اسپلش زنانه Charm سی گل 200 میل",
    image: "https://mootanroo.com/images/thumbs/0215114_seagull-body-splash-charm-205113011901.jpg.jpeg",
    description: `رول دئودورانت زنانه شون مدل Heaven Flower دارای فرمولاسیون مدرن با حداکثر اثربخشی برای جلوگیری از تعریق و ایجاد بوی بد در تمام طول روز است. بهره ­گیری از عصاره های گیاهی و تلفیق شگفت انگیزی از رایحه های طبیعی گلهای سفید و میوه ­های تازه رایحه­ های ملایم زنانه را به شما هدیه می دهد.این محصول فاقد الکل بوده و روی لباس لکه ایجاد نمی­کند. دئودورانت شون مناسب تمامی انواع پوست می باشد. فرمولاسیون مدرن با بهره­ گیری از خواص گیاهی و رایحه­ های شگفت­ انگیز طبیعی، بدون استفاده از الکل و پارابن، این محصول را برای تمامی انواع سلیقه­ ها و تمامی انواع پوست­ها مناسب ساخته است.`,
    price: "۸۹/۷۰۰تومان"
  },
  {
    id: 106,
    title: "بادی اسپلش مردانه سی گل مدل Platinum حجم 200 میل",
    image: "https://mootanroo.com/images/thumbs/0230701_seagull-shimmer-body-splash-platinum-205113011906-01.jpg.jpeg",
    description: `بادی اسپلش مردانه سی گل مدل Platinum، با کیفیت بسیار بالا و بدون مواد شیمیایی و مضر برای پوست، تهیه و تولید شده است. این اسپری غنی شده با روغن‌ها، مرطوب کننده‌ها و ترکیبات طبیعی برای خوشبو و باطراوت کردن پوست، است. استفاده از این بادی اسپلش موجب آب‌رسانی به پوست و جلوگیری از تعریق بیش از حد می گردد. همچنین این محصول شفافیت بیشتر و نرمی و تازگی فوق العاده ای به پوست می بخشد و رایحه عالی و ماندگار چای سبز را برای شما به ارمغان می آورد. تست حساسیت: قبل از استفاده، بادی اسپلش را روی بخش کوچکی از پوست داخل بازو اسپری کنید. پس از 24 ساعت، در صورت عدم بروز حساسیت، اسپری را مطابق نحوه ذکر شده، استفاده کنید.
        `,
    price: "۱۲۹/۵۰۰تومان"
  },
  {
    id: 107,
    title: "بادی اسپلش مردانه Elegant سی گل 200 میل",
    image: "https://mootanroo.com/images/thumbs/0215123_seagull-body-splash-elegant-205113011903.jpg.jpeg",
    description: `قیمت و خرید بادی اسپلش مردانه Elegant سی گل 200 میل اگر قصد استفاده از بادی اسپلش ها را به منظور جلوگیری از تعریق بدن دارید، باید بدانید که این محصولات جلوی عرق ریزی شما را نمی گیرند بلکه فقط بوی بد بدن را از بین می برند و به جای آن رایحه های خوش را جایگزین می سازند. برای جلوگیری از تعریق باید از محصولات ضد عرق مثل انواع مام های رولی و یا اسپری استفاده نمایید. بادی اسپلش مردانه الگانت، محصولی دیگر از برند سی گل می باشد که با داشن رایحه خوش و ماندگار، همانند نامش کاملا برازنده شما می باشد و با استفاده از آن به اطرافیانتان ثابت خواهید کرد که مردی شیک پوش و خوش سلیقه می باشید. اگر به دنبال خرید بادی اسپلش مردانه Elegant سی گل 200 میل، هستید از فروشگاه اینترنتی مو تن رو اقدام نمایید.
  ...
  {
    id: 108,
    title: "بادی اسپلش Cool Ocean مای 220 میل",
    image: "https://mootanroo.com/images/thumbs/0213388_my-body-splash-120113011902.jpg.jpeg",
    description: `قیمت و خرید بادی اسپلش مردانه Elegant سی گل 200 میل اگر قصد استفاده از بادی اسپلش ها را به منظور جلوگیری از تعریق بدن دارید، باید بدانید که این محصولات جلوی عرق ریزی شما را نمی گیرند بلکه فقط بوی بد بدن را از بین می برند و به جای آن رایحه های خوش را جایگزین می سازند. برای جلوگیری از تعریق باید از محصولات ضد عرق مثل انواع مام های رولی و یا اسپری استفاده نمایید. بادی اسپلش مردانه الگانت، محصولی دیگر از برند سی گل می باشد که با داشن رایحه خوش و ماندگار، همانند نامش کاملا برازنده شما می باشد و با استفاده از آن به اطرافیانتان ثابت خواهید کرد که مردی شیک پوش و خوش سلیقه می باشید. اگر به دنبال خرید بادی اسپلش مردانه Elegant سی گل 200 میل، هستید از فروشگاه اینترنتی مو تن رو اقدام نمایید.
  ...
  {
    id: 109,
    title: "بادی اسپلش کالیستا مدل Taylor حجم 200 میل",
    image: "https://mootanroo.com/images/thumbs/0298963_calista-taylor-294000000009.jpg.jpeg",
    description: `قیمت و خرید بادی اسپلش مای مدل Cool Ocean 220 میل در طول روز بدن انسان دچار عرق ریزی و در نتیجه ایجاد بوی بد بدن خواهد شد که البته این مسئله در روزهای گرم سال و یا هنگام انجام فعالیت‌های مختلف، بیشتر خواهد شد. برای جلوگیری از این بوی آزار دهنده، باید از محصولات خوشبو کننده مختلف از جمله بادی اسپلش استفاده کرد تا رایحه خوش و دل انگیز جایگزین این بوی بد گردد. بادی اسپلش " کول اوشن" مای، یکی از این محصولات با کیفیت بالا می‌باشد که با قیمت بسیار اقتصادی و به صرفه در فروشگاه اینترنتی مو تن رو موجود می باشد تا در صورت تمایل آن را سفارش دهید.
  ...
  {
    id: 110,
    title: "بادی اسپلش کالیستا مدل Selena حجم 200 میل",
    image: "https://mootanroo.com/images/thumbs/0379854_-selena-200-.jpeg",
    description: `بادی اسپلش‌ها به دلیل مرطوب، نرم و درخشان کردن پوست در کنار رایحه‌ای فوق‌العاده از محبوبیت بسیار زیادی برخوردار هستند. بادی اسپلش کالیستا مدل Taylor با رایحه خنک و معتدل آغاز می‌شود که همین ویژگی آن را گزینه‌ای مناسب برای روزهای گرم تابستان کرده است. بادی اسپلش کالیستا مدل Taylor با نت توت‌های وحشی آغاز می‌شود و خستگی روزمره را از شما دور می‌کند و انرژی بسیار زیادی را به شما هدیه می‌دهد. پس از گذشت چند ثانیه از اولین اسپری بر پوست خود رایحه زنبق بنفشه و جاسمین مشام شما را پر خواهد کرد و انرژی جوانی شما را به طرز چشم‌گیری نمایان می‌کند. در انتها این بادی اسپلش با نت چوبی اما دوست داشتنی مشک، خزه بلوط و کهربا پایان می‌یابد. همچنین حضور گلیسیرین در این بادی اسپلش باعث رطوبت رسانی به پوست شما شده و آن را لطیف می‌کند.
...
const allProducts = [...newProducts, ...popularProuducts, ...products]
...
const Header = () => {
  ...
  const [searchResult, toggleSearchResults] = useState(false)


  const [visibleProducts, setVisbileProducts] = useState(allProducts)
  ...
  function handleInputChange(e) {
    ...
    allProducts.forEach((item, key) => {
      if (item.title.includes(e.target.value)) {
        similarProdcuts.push(item)
      }
    })

    setVisbileProducts(similarProdcuts)
      ...
      <div className="mid">
        <div className="search">
          ...
          <input
            ...
            type="text"
            placeholder='محصول, دسته و یا برند مورد نظرتان ا جستجو کنید' />

        </div>
      </div>
      <div className="left">
        <button className="user" onClick={() => { setPage("/user-page") }}>
          <Icon icon="ph:user" />
          <span>حساب کاربری</span>
        </button>
        <button className="shopping-cart" onClick={() => { setPage("/shopping-cart-page") }}>
          <Icon icon="ph:bag-thin" />
          <span>سبد خرید</span>
        </button>
      </div>

      <div className={`search-result ${searchResult ? "search-result-open" : ""}`}>
        <h1 className='results-header'>
          <span>نتایج جستجوی شما</span>
          <button onClick={() => toggleSearchResults(false)}>
            <Icon icon="zondicons:close-solid" />بستن</button>
        </h1>
              ...
              <div className="card" onClick={() => cardClickHandler(item)} >
                ...
                <div className="card-body">
                  ...
                  <div className="card-buttons">
                    <button className="buy" onClick={() => cardClickHandler(item)} >
